...
Internship: Oasis Infobyte Data Science Internship (OIBSIP) Track: Data Science
...
scikit-learn
Approach
Loaded the dataset and converted it into a labeled DataFrame.
Performed EDA — checked shape, data types, missing values, and descriptive statistics.
Visualized feature distributions using a pairplot and per-feature box plots grouped by species.
Identified petal length and petal width as the most discriminative features based on the visualizations.
Split the data into training and test sets (80/20, stratified).
Trained three classifiers: Logistic Regression, K-Nearest Neighbours, and Decision Tree.
